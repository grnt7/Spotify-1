...
const LOGIN_URL = "https://accounts.spotify.com/authorize?" +
  new URLSearchParams({
    ...
    client_id: process.env.SPOTIFY_CLIENT_ID, // Use consistent environment variable name
  }).toString();

const spotifyApi = new SpotifyWebApi({
  clientId: process.env.SPOTIFY_PUBLIC_CLIENT_ID,
  clientSecret: process.env.SPOTIFY_PUBLIC_CLIENT_SECRET,
  redirectUri: "http://127.0.0.1:3000/api/auth/callback/spotify", // Ensure consistency
});
